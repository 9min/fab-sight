...
```
src/stores/
├── useDashboardStore.ts    # 선택된 Lot/Wafer, 센서 필터, 기간, Compare 모드
...
interface DashboardState {
  ...
  selectedSensors: string[];         // 표시할 센서 목록
...
// Query Key 컨벤션
["lots"]                         // Lot 목록
["lot", lotId]                   // 특정 Lot 상세 데이터
["lot", lotId, "process-data"]   // 특정 Lot의 공정 데이터 (시계열)
["golden-lot"]                   // Golden Lot 데이터
```
