...
│   ├── app/                    # 앱 진입점, 라우팅 설정
│   ├── components/             # 컴포넌트
│   │   ├── ui/                 # 기본 UI 컴포넌트 (LotSelector, SensorCheckbox, AnomalyToggle 등)
│   │   ├── layout/             # 레이아웃 컴포넌트 (TopNav, Sidebar, MainContent)
│   │   ├── charts/             # ECharts 차트 컴포넌트 (TimeSeriesChart, RadarChart, buildChartOption 등)
