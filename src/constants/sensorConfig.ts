	...
	"CVD-PECVD": [
		{
			...
			unit: "°C",
			color: "#EF4444",
			specLimits: { usl: 420, lsl: 380, ucl: 415, lcl: 385 },
		},
		{
			key: "pressure",
			label: "Pressure",
			unit: "Torr",
			color: "#3B82F6",
			specLimits: { usl: 4.0, lsl: 3.0, ucl: 3.8, lcl: 3.2 },
		},
		{
			key: "rfPower",
			label: "RF Power",
			unit: "W",
			color: "#F59E0B",
			specLimits: { usl: 450, lsl: 350, ucl: 430, lcl: 370 },
		},
		{
			key: "rfReflected",
			label: "RF Reflected",
		...
		},
		{
			...
			unit: "sccm",
			color: "#22C55E",
			specLimits: { usl: 220, lsl: 180, ucl: 215, lcl: 185 },
		},
		{
			key: "NH3_flow",
			label: "NH3 Flow",
			unit: "sccm",
			color: "#10B981",
			specLimits: { usl: 1100, lsl: 900, ucl: 1050, lcl: 950 },
		},
	...
	"CVD-LPCVD": [
		{
			...
			unit: "°C",
			color: "#EF4444",
			specLimits: { usl: 630, lsl: 610, ucl: 625, lcl: 615 },
		},
		{
			key: "pressure",
			label: "Pressure",
			unit: "Torr",
			color: "#3B82F6",
			specLimits: { usl: 0.5, lsl: 0.1, ucl: 0.4, lcl: 0.2 },
		},
	...
	"ETCH-OXIDE": [
		{
			...
			unit: "°C",
			color: "#F97316",
			specLimits: { usl: 50, lsl: 30, ucl: 45, lcl: 35 },
		},
		{
			key: "pressure",
			label: "Pressure",
			unit: "mTorr",
			color: "#3B82F6",
			specLimits: { usl: 60, lsl: 40, ucl: 55, lcl: 45 },
		},
		{
			key: "sourcePower",
			label: "Source Power",
	...
	"ETCH-DEEP": [
		{
			...
			unit: "°C",
			color: "#EF4444",
			specLimits: { usl: 25, lsl: 15, ucl: 23, lcl: 17 },
		},
		{
			key: "pressure",
			label: "Pressure",
			unit: "mTorr",
			color: "#3B82F6",
			specLimits: { usl: 40, lsl: 15, ucl: 35, lcl: 20 },
		},
		{
			key: "sourcePower",
			label: "Source Power",
